...
const ClerkScreen = ({
  ...
  const isTestDecksAvailable = isLiveMode || (!isLiveMode && appMode.isVxMark)
  return (
    <React.Fragment>
      <Main>
            ...
            {election && (
              <React.Fragment>
                ...
                <SegmentedButton>
                  ...
                  <Button
                    onPress={() => setAppMode(VxPrintOnly)}
                  ...
                  <Button
                    onPress={() => setAppMode(VxMarkPlusVxPrint)}
