...
class TrackerPage extends React.Component<RouteComponentProps, State> {
  ...
  public componentDidUpdate = () => {
    if (!this.printCalled && this.state.tracker) {
