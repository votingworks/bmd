...
it(`basic end-to-end flow`, async () => {
  ...
  fireEvent.change(getByTestId('activation-code'), {
    // the alternate activation code that picks the other ballot style
  ...
  // make sure there are as many questions as we expect
  getByText('1 of 11')
  ...
  // Vote for Measure 102 contest (should still be in district)
